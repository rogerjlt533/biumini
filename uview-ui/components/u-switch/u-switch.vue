<template>
	<view class="u-switch" :class="[value == true ? 'u-switch--on' : '', disabled ? 'u-switch--disabled' : '']"
		...
		<view v-show="value === true" style="margin: 3rpx auto 2rpx 12rpx;color: #FFFFFF;">{{text[1]}}</view>
		...
		<view v-show="value !== true" style="margin: 3rpx 12rpx 2rpx auto;color: #FFFFFF;">{{text[0]}}</view>
	</view>
</template>
...
<style lang="scss" scoped>
	...
	.u-switch--on {
		background-color: #DBDBD8; //#1989fa;
	}
