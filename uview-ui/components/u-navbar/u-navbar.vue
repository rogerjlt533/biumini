	...
	<view>
		<view class="u-navbar" :style="[navbarStyle]"
			...
			<view class="u-navbar-inner" :style="[navbarInnerStyle]">
				<view class="u-back-wrap" v-if="!isBack"></view>
				<view class="u-back-wrap" v-else @tap="goBack">
					<view class="u-icon-wrap">
						<u-image :src="srcleft" :width="imgwidth" :height="imgheight" mode="heightFix"></u-image>
					</view>
				</view>
...
<style scoped lang="scss">
	...
	.u-back-wrap {
		...
		flex: 1;
		flex-grow: 0;
		padding: 14rpx 14rpx 14rpx 44rpx;
	}
